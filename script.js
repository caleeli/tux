...
function gameLoader(number)
{
	...
	if(num === 1)
	{
	var putContent = '<iframe src="http://localhost/tux/migratingFlocks.html" width="100%" height="100%" frameborder="0" marginheight="0" marginwidth="0">Loading Please wait</iframe> ';
	...
	{
	var putContent = '<iframe src="http://localhost/tux/catchTheFlow.html" width="100%" height="100%" frameborder="0" marginheight="0" marginwidth="0">Loading Please wait</iframe> ';
	document.getElementById('GamesPage').innerHTML = putContent;
	...
	{
	var putContent = '<iframe src="http://localhost/tux/highOrLow.html" width="100%" height="100%" frameborder="0" marginheight="0" marginwidth="0">Loading Please wait</iframe> ';
	document.getElementById('GamesPage').innerHTML = putContent;
	...
	{
	var putContent = '<iframe src="http://localhost/tux/mindMath.html" width="100%" height="100%" frameborder="0" marginheight="0" marginwidth="0">Loading Please wait</iframe> ';
	document.getElementById('GamesPage').innerHTML = putContent;
	...
	{
	var putContent = '<iframe src="http://localhost/tux/passiveOn.html" width="100%" height="100%" frameborder="0" marginheight="0" marginwidth="0">Loading Please wait</iframe> ';
	document.getElementById('GamesPage').innerHTML = putContent;
	...
	{
	var putContent = '<iframe src="http://localhost/tux/highClick.html" width="100%" height="100%" frameborder="0" marginheight="0" marginwidth="0">Loading Please wait</iframe> ';
	document.getElementById('GamesPage').innerHTML = putContent;
	...
	{
	var putContent = '<iframe src="http://localhost/tux/flashBack.html" width="100%" height="100%" frameborder="0" marginheight="0" marginwidth="0">Loading Please wait</iframe> ';
	document.getElementById('GamesPage').innerHTML = putContent;
	...
	{
	var putContent = '<iframe src="http://localhost/tux/mathOperations.html" width="100%" height="100%" frameborder="0" marginheight="0" marginwidth="0">Loading Please wait</iframe> ';
	document.getElementById('GamesPage').innerHTML = putContent;
	...
	{
	var putContent = '<iframe src="http://localhost/tux/doubleTrouble.html" width="100%" height="100%" frameborder="0" marginheight="0" marginwidth="0">Loading Please wait</iframe> ';
	document.getElementById('GamesPage').innerHTML = putContent;
	...
	{
	var putContent = '<iframe src="http://localhost/tux/driftME.html" width="100%" height="100%" frameborder="0" marginheight="0" marginwidth="0">Loading Please wait</iframe> ';
	document.getElementById('GamesPage').innerHTML = putContent;
	...
	{
	var putContent = '<iframe src="/tux/motionCommotion.html" width="100%" height="100%" frameborder="0" marginheight="0" marginwidth="0">Loading Please wait</iframe> ';
	document.getElementById('GamesPage').innerHTML = putContent;
