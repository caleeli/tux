...
function gameLoader(number)
{
	...
	if(num === 1)
	{
	var putContent = '<iframe src="/tux/migratingFlocks.html" width="100%" height="100%" frameborder="0" marginheight="0" marginwidth="0">Loading Please wait</iframe> ';
	...
	{
	var putContent = '<iframe src="/tux/catchTheFlow.html" width="100%" height="100%" frameborder="0" marginheight="0" marginwidth="0">Loading Please wait</iframe> ';
	document.getElementById('GamesPage').innerHTML = putContent;
	...
	{
	var putContent = '<iframe src="/tux/highOrLow.html" width="100%" height="100%" frameborder="0" marginheight="0" marginwidth="0">Loading Please wait</iframe> ';
	document.getElementById('GamesPage').innerHTML = putContent;
	...
	{
	var putContent = '<iframe src="/tux/mindMath.html" width="100%" height="100%" frameborder="0" marginheight="0" marginwidth="0">Loading Please wait</iframe> ';
	document.getElementById('GamesPage').innerHTML = putContent;
	...
	{
	var putContent = '<iframe src="/tux/passiveOn.html" width="100%" height="100%" frameborder="0" marginheight="0" marginwidth="0">Loading Please wait</iframe> ';
	document.getElementById('GamesPage').innerHTML = putContent;
	...
	{
	var putContent = '<iframe src="/tux/highClick.html" width="100%" height="100%" frameborder="0" marginheight="0" marginwidth="0">Loading Please wait</iframe> ';
	document.getElementById('GamesPage').innerHTML = putContent;
	...
	{
	var putContent = '<iframe src="/tux/flashBack.html" width="100%" height="100%" frameborder="0" marginheight="0" marginwidth="0">Loading Please wait</iframe> ';
	document.getElementById('GamesPage').innerHTML = putContent;
	...
	{
	var putContent = '<iframe src="/tux/mathOperations.html" width="100%" height="100%" frameborder="0" marginheight="0" marginwidth="0">Loading Please wait</iframe> ';
	document.getElementById('GamesPage').innerHTML = putContent;
	...
	{
	var putContent = '<iframe src="/tux/doubleTrouble.html" width="100%" height="100%" frameborder="0" marginheight="0" marginwidth="0">Loading Please wait</iframe> ';
	document.getElementById('GamesPage').innerHTML = putContent;
	...
	{
	var putContent = '<iframe src="/tux/driftME.html" width="100%" height="100%" frameborder="0" marginheight="0" marginwidth="0">Loading Please wait</iframe> ';
	document.getElementById('GamesPage').innerHTML = putContent;
